...
public class Patient {
    ...
    public Patient(String id, String nickName, String name, String surname, String birthDate, String phone, String address, String language) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (nickName != null ? !nickName.equals(patient.nickName) : patient.nickName != null)
            return false;
        ...
        if (address != null ? !address.equals(patient.address) : patient.address != null)
            return false;
        return !(language != null ? !language.equals(patient.language) : patient.language != null);
